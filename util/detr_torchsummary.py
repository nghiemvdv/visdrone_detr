...
def summary_string(model, input_size, batch_size=-1, device=torch.device('cuda:0'), dtypes=None):
    ...
    def register_hook(module):
        def hook(module, input, output):
            ...
            ###
            # print(str(module.__class__), m_key)
            # print(type(input))
            ...
            try:
                ...
                elif isinstance(input[0], (NestedTensor,)):
                    summary[m_key]["input_shape"] = list(input[0].tensors.size())
            ...
            #     ]
                ...
                try:
                    ...
                    try:
                        summary[m_key]["output_shape"] = [
                            [-1] + list(o.tensors.size())[1:] for _, o in output.items()
                        ]
                    except:
                        # print(output.keys())
